...
func (t *Tracing) InstrumentHTTP(options options) {
	...
	t.Client = NewClient(t.vu, options)
	...
	mustSetHTTPMethod("del", httpModuleObj, t.Client.Del)
	mustSetHTTPMethod("get", httpModuleObj, t.Client.Get)
	mustSetHTTPMethod("head", httpModuleObj, t.Client.Head)
	mustSetHTTPMethod("options", httpModuleObj, t.Client.Options)
	mustSetHTTPMethod("patch", httpModuleObj, t.Client.Patch)
	mustSetHTTPMethod("post", httpModuleObj, t.Client.Patch)
	mustSetHTTPMethod("put", httpModuleObj, t.Client.Patch)
	mustSetHTTPMethod("request", httpModuleObj, t.Client.Request)
}
